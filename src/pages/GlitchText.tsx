...
const GlitchText: FC<GlitchTextProps> = ({
  ...
  const inlineStyles: CustomCSSProperties = {
    ...
    '--before-shadow': enableShadows ? '5px 0 orange' : 'none'
  };

  const baseClasses = 'text-white text-[clamp(1.1rem,1vw,1rem)] font-black relative mx-auto select-none ml-5 cursor-pointer';
