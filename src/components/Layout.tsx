...
import GlitchText from '../pages/GlitchText';
...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-dark-bg text-zinc-100 selection:bg-red-500/30 selection:text-red-200 flex flex-col">
      {/* Navigation */}
      <Navigation />
      ...
      <div ref={sidebarRef} className="fixed left-6 bottom-0 z-50 hidden md:flex flex-col items-center gap-6 after:content-[''] after:w-[1px] after:h-24 after:bg-zinc-700 after:mt-6">
        <a href="https://github.com/sonixx02" target="_blank" rel="noopener noreferrer" 
           className="text-zinc-400 hover:text-red-500 hover:-translate-y-1 transition-all duration-300 transform"
      ...
      <div className="fixed right-6 bottom-0 z-50 hidden md:flex flex-col items-center gap-6 after:content-[''] after:w-[1px] after:h-24 after:bg-zinc-700 after:mt-6">
        <a
          href="mailto:soni.darshan0209@gmail.com"
          className="group relative w-8 h-80 transition-all duration-300 hover:-translate-y-1 mb-6"
        >
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rotate-90 whitespace-nowrap">
            <GlitchText
              ...
              enableShadows={true}
              enableOnHover={false}
              className="text-zinc-400 group-hover:text-red-500 text-base tracking-widest"
            >
